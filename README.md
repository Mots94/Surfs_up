...
* In both June and December, there are low and high outliers in this dataset, though the exact number of outliers is not known.  The formulas *Q1 - inter-quartile range (IQR) * 1.5* and *Q3 + IQR * 1.5* were used to make this determination.  